...
xterm -e mongod --shardsvr --port 27024 --bind_ip 127.0.0.1 --dbpath shard2/db1/ --replSet rs1&
xterm -e mongod --shardsvr --port 27025 --bind_ip 127.0.0.1 --dbpath shard2/db2/ --replSet rs1&
xterm -e mongod --shardsvr --port 27026 --bind_ip 127.0.0.1 --dbpath shard2/db3/ --replSet rs1&

echo "Running shard 2 : "
xterm -e mongod --shardsvr --port 27027 --bind_ip 127.0.0.1 --dbpath shard2/db1/ --replSet rs2&
xterm -e mongod --shardsvr --port 27028 --bind_ip 127.0.0.1 --dbpath shard2/db2/ --replSet rs2&
xterm -e mongod --shardsvr --port 27029 --bind_ip 127.0.0.1 --dbpath shard2/db3/ --replSet rs2&
